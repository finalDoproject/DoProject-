    ...
    $.fn.BootSideMenu = function (userOptions) {
        ...
        function startDefault() {
            if (options.side === "left") {
                if (options.autoClose) {
                    ...
                    $menu.status = "opened";
                    if (options.pushBody) {
                        $DOMBody.css("margin-left", $menu.width());
                    }
                }
            } else if (options.side === "right") {
                if (options.autoClose) {
                    ...
                    $menu.status = "opened";
                    if (options.pushBody) {
                        $DOMBody.css("margin-right", $menu.width() );
                    }
                }
            }
        }
        ...
        function openMenu(execFunctions) {
            ...
            if (options.side === "left") {
                ...
                if (options.pushBody) {
                    $DOMBody.animate({marginLeft: $menu.width()}, {duration: options.duration});
                }
                ...
                if (options.pushBody) {
                    $DOMBody.animate({marginRight: $menu.width()}, {duration: options.duration});
                }
